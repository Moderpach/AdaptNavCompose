...
@Composable
public fun NavBackStackEntry.ListLocalOwnersProvider(
...
private fun SaveableStateHolder.SaveableStateProvider(content: @Composable () -> Unit) {
    val viewModel = viewModel<ListEntryIdViewModel>()
...
internal class ListEntryIdViewModel(handle: SavedStateHandle) : ViewModel() {

    private val IdKey = "SaveableStateHolder_ListEntryKey"
